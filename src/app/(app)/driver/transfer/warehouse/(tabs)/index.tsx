...
import { getWarehouseTransferShipmentsByStatus } from "@/api/shipment/transfer/warehouse"
...
export default function Page() {
  const { status, data, error, fetchStatus, refetch } = useQuery({
    queryKey: ["getWarehouseTransferShipmentsByStatus", "IN_TRANSIT"],
    queryFn: () => getWarehouseTransferShipmentsByStatus("IN_TRANSIT"),
  })
              ...
              <>
                {[...data.shipments].reverse().map((shipment) => (
                  <Link
                    ...
                    key={shipment.id}
                    href={{
                      pathname: "/(app)/driver/transfer/warehouse/[id]/",
                      params: {
                        id: shipment.id,
                      },
                    }}
